...
import { CodeBlock, Paragraph, Progress, Title } from "@dreamer/ui-view";
...
const PROGRESS_API: ApiRow[] = [
  { name: "percent", type: "number", default: "-", description: "进度 0–100" },
  {
    name: "type",
    type: "line | circle",
    default: "line",
    ...
    <div class="space-y-10">
      <section>
        ...
        <Paragraph class="mt-2">
          ...
          format。 使用 Tailwind v4，支持 light/dark 主题。
        </Paragraph>
      </section>
